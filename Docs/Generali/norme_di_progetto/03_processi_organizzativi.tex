...
di supporto e la gestione del personale.
    ...
    \subsection{Gestione di Infrastrutture}
        ...
        dove: 
        \begin{itemize}
            \item \textbf{add}: viene utilizzato quando si va ad aggiungere una nuova sezione o sottosezione;
            \item \textbf{change}: viene utilizzato quando si va a modificare il documento già esistente;
